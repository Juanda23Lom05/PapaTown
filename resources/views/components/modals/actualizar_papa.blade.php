<div class="modal fade" id="modal-{{ md5($papa->id) }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-warning">
                <h5 class="modal-title">📦 Editar Registro: REF-{{ strtoupper(substr(md5($papa->id), 0, 6)) }}</h5>
            ...
            <form action="{{ route('crud.view.update', $papa->id) }}" method="POST">
                ...
                <div style="display: none !important; visibility: hidden;">
                    <input type="hidden" name="internal_id" value="{{ $papa->id }}">
                </div>
